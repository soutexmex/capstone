...
<html>
    ...
    <div>
        <p><i>Need to get a hold of the webmaster?</i>  
        </br>
        </br>
        <b>just click the link at the bottom of the page</b></P>
        </br>
    </div>
     <div>
        </br>
        </br>
        <h2>Austin, Texas is home - "Live Music Capital of the World"</h2>
        <h5> click on image for Austin's homepage </h5>
        <h2><a href="http://www.austintexas.org/visit/"><img class="displayed" src="images/Austin.jpg" alt="Austin, Texas"></a></h2>
        </br>
    </div>
    </br>
    </br>
